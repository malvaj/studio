                ...
                <TableBody>
                  {state.items.map((item) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell>{new Intl.NumberFormat('eu-ES', { style: 'currency', currency: 'EUR' }).format(item.price)}</TableCell>
                      <TableCell>
                      ...
                      <TableCell className="text-right">{new Intl.NumberFormat('eu-ES', { style: 'currency', currency: 'EUR' }).format(item.price * item.quantity)}</TableCell>
                      <TableCell>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  <span>Subtotala</span>
                  <span>{new Intl.NumberFormat('eu-ES', { style: 'currency', currency: 'EUR' }).format(subtotal)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Bidalketa</span>
