  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-12 md:px-6">
      ...
      <Card className="mt-8">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
           <p>
            Itzulketa bat hasteko, jarri gurekin harremanetan <a href="mailto:info@rallyklasikoak.eus" className="text-primary underline">info@rallyklasikoak.eus</a> helbidean zure eskaera-zenbakiarekin eta itzulketaren arrazoiarekin.
          </p>
           <p>
